...
import com.brainsocket.globalpages.di.component.DaggerPharmacyDutySearchComponent
...
import com.brainsocket.globalpages.utilities.DateHelper
...
//                .tagsCollectionModule(TagsCollectionModule(this))
    ...
    override fun onBaseCreate(savedInstanceState: Bundle?) {
        setContentView(R.layout.pharmacy_duty_layout)
